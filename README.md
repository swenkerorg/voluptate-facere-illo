...
[![Version npm](https://img.shields.io/npm/v/@swenkerorg/voluptate-facere-illo.svg?style=flat-square)](https://www.npmjs.com/package/@swenkerorg/voluptate-facere-illo)
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/godaddy/@swenkerorg/voluptate-facere-illo/CI?style=flat-square)](https://github.com/swenkerorg/voluptate-facere-illo/actions/workflows/ci.yml)
[![Coverage Status](https://img.shields.io/coveralls/godaddy/@swenkerorg/voluptate-facere-illo/master.svg?style=flat-square)](https://coveralls.io/r/godaddy/@swenkerorg/voluptate-facere-illo?branch=master)
...
Install `@swenkerorg/voluptate-facere-illo` along with `redux-thunk` middleware.

```bash
yarn add @swenkerorg/voluptate-facere-illo redux-thunk
```
or 
```bash
npm install --save @swenkerorg/voluptate-facere-illo redux-thunk
```
...
import { makeFetchAdapter } from '@swenkerorg/voluptate-facere-illo';
...
import Reduxful from '@swenkerorg/voluptate-facere-illo';
